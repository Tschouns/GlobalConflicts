...
namespace Services
{
    public class ImportConflictCatalogFileService : IImportConflictCatalogFile
    {
        public void Import(string fileName, IInsert<ImportedConflictModel> targetRepository)
        {
